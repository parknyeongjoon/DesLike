using UnityEngine;
//enum 모음
public enum Mouse_State { Idle, Click, Drag, Skill }
...
public enum State { Idle, Detect, Siege, Battle, Heal ,Stun, Dead}//유닛들 상태
...
public enum SkillType { activeSkill, passiveSkill}
