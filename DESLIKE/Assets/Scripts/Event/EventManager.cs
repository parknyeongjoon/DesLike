...
public class EventManager : MonoBehaviour
{
    ...
    [SerializeField] GameObject RelicEvent, HealEvent, AreaEvent, PenaltyEvent, 
        ShopEvent, GambleEvent, FightEvent, PortEvent;
